  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
          <h1 className="text-3xl font-serif font-bold text-slate-800">Agendamentos</h1>
          <p className="text-slate-500">Gerencie os horários e solicitações de clientes.</p>
        </div>
                    ...
                    <>
                      ...
                      <div className="space-y-1">
                        ...
                        {appointmentsForDay(day).length > 3 && (
                          <div className="text-[10px] text-slate-400 font-bold px-1">+{appointmentsForDay(day).length - 3} mais</div>
                        )}
                      </div>
                    </>
                  )}
          ...
          <table className="w-full text-left">
            <thead>
              <tr className="bg-slate-50 border-b">
                <th className="px-6 py-4 text-sm font-bold text-slate-500">Cliente</th>
                <th className="px-6 py-4 text-sm font-bold text-slate-500">Serviço/Profissional</th>
                <th className="px-6 py-4 text-sm font-bold text-slate-500">Data/Hora</th>
                <th className="px-6 py-4 text-sm font-bold text-slate-500">Status</th>
                <th className="px-6 py-4 text-sm font-bold text-slate-500">Ações</th>
              </tr>
            </thead>
