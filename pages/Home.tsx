    ...
    <div className="overflow-x-hidden">
      ...
      <section className="relative min-h-screen flex items-center pt-20">
        ...
        <div className="absolute bottom-12 left-1/2 -translate-x-1/2 flex flex-col items-center animate-bounce text-white/50 cursor-pointer" onClick={scrollToServices}>
          <span className="text-[10px] font-bold uppercase tracking-widest mb-2">Descubra</span>
      ...
      <section className="py-20 bg-white border-b border-slate-100">
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-3 gap-12">
          <div className="flex items-start space-x-5">
            ...
            <div>
              <h4 className="font-bold text-xl mb-2 text-slate-800">Resultados Impecáveis</h4>
              <p className="text-slate-500 text-sm leading-relaxed">Combinamos arte e ciência para entregar o visual dos seus sonhos com precisão absoluta.</p>
            </div>
          </div>
          <div className="flex items-start space-x-5">
            ...
            <div>
              <h4 className="font-bold text-xl mb-2 text-slate-800">Produtos Premium</h4>
              <p className="text-slate-500 text-sm leading-relaxed">Utilizamos apenas marcas líderes mundiais, garantindo a saúde e brilho duradouro.</p>
            </div>
          </div>
          <div className="flex items-start space-x-5">
            <div className="bg-rose-50 p-4 rounded-2xl text-rose-500">
            ...
            <div>
              <h4 className="font-bold text-xl mb-2 text-slate-800">Experiência VIP</h4>
              <p className="text-slate-500 text-sm leading-relaxed">Seu momento de luxo começa na recepção com um café gourmet e atendimento personalizado.</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex flex-col lg:flex-row lg:items-end justify-between mb-20 gap-8">
            <div className="max-w-2xl">
              <h2 className="text-5xl md:text-7xl font-serif font-bold text-slate-900 mb-6 tracking-tight">{settings.servicesTitle}</h2>
              <p className="text-lg text-slate-500 leading-relaxed">{settings.servicesSubtitle}</p>
            </div>
            <button onClick={onBookNow} className="group flex items-center space-x-3 text-rose-500 font-black uppercase tracking-widest text-xs hover:text-rose-600 transition">
              <span>Explorar menu completo</span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {activeServices.map((service, idx) => (
              ...
              >
                ...
                <h3 className="text-2xl font-black mb-4 text-slate-900 group-hover:text-rose-600 transition-colors">{service.name}</h3>
                <p className="text-slate-500 text-sm leading-relaxed mb-10 flex-1">{service.description}</p>
                <div className="flex items-center justify-between pt-6 border-t border-slate-50">
                  <span className="text-2xl font-black text-slate-900">R$ {service.price}</span>
      ...
      <section className="py-32 bg-slate-950 text-white overflow-hidden relative">
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          <div className="text-center mb-24">
            ...
            <h2 className="text-5xl md:text-7xl font-serif font-bold mb-8 tracking-tight">{settings.professionalsTitle}</h2>
            <p className="text-slate-400 max-w-2xl mx-auto text-lg leading-relaxed font-light">{settings.professionalsSubtitle}</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {professionals.map((pro) => (
              <div key={pro.id} className="group relative">
                ...
                <p className="text-slate-500 font-black text-[10px] tracking-[0.2em] uppercase mb-4">{pro.role}</p>
                <p className="text-slate-400 text-sm italic line-clamp-2 leading-relaxed opacity-60 group-hover:opacity-100 transition-opacity">"{pro.bio}"</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-32 bg-white relative">
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-24 items-center">
          <div className="relative group">
            ...
            <div className="absolute -bottom-10 -right-10 z-20 bg-white p-8 rounded-[2rem] shadow-2xl max-w-[280px] hidden md:block">
              <div className="flex items-center space-x-3 mb-4">
                ...
                <span className="text-[10px] font-black text-slate-400 uppercase tracking-widest">+500 Clientes</span>
              </div>
              <p className="text-sm font-bold text-slate-800 leading-tight">"O melhor salão que já visitei. Atendimento impecável e luxuoso!"</p>
          ...
          <div className="lg:pl-12">
            ...
            <h2 className="text-5xl md:text-7xl font-serif font-bold text-slate-900 mb-10 leading-[1] tracking-tight">{settings.aboutTitle}</h2>
            <p className="text-slate-600 mb-12 text-lg leading-relaxed font-light">{settings.aboutText}</p>
            ...
            <div className="space-y-6 mb-16">
              <div className="flex items-center space-x-6 p-6 rounded-3xl border border-slate-50 hover:bg-slate-50 transition duration-300">
                ...
                <div>
                  <h4 className="font-black text-slate-900 text-lg">Visite nossa Casa</h4>
              ...
              <div className="flex items-center space-x-6 p-6 rounded-3xl border border-slate-50 hover:bg-slate-50 transition duration-300">
                ...
                <div>
                  <h4 className="font-black text-slate-900 text-lg">Horários Flexíveis</h4>
                  <p className="text-slate-500 text-sm font-medium">Consulte nosso cronograma para agendar seu momento.</p>
                </div>
              </div>
            </div>
      ...
      <footer className="bg-slate-950 pt-32 pb-12 text-white relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-24 pb-24 border-b border-white/10 mb-20">
            <div>
              ...
              <p className="text-slate-400 text-xl leading-relaxed max-w-md font-light mb-12">
                Elevando padrões de beleza e bem-estar através de experiências memoráveis e técnicas artesanais.
              </p>
            </div>
            ...
            <div className="grid grid-cols-2 gap-12">
              <div>
                ...
                <ul className="space-y-4">
                  <li><button onClick={() => window.scrollTo({top: 0, behavior: 'smooth'})} className="text-slate-400 hover:text-white transition font-medium">Início</button></li>
                  <li><button onClick={onBookNow} className="text-slate-400 hover:text-white transition font-medium">Agendamento</button></li>
                  <li><button onClick={scrollToServices} className="text-slate-400 hover:text-white transition font-medium">Menu de Serviços</button></li>
                  <li><button className="text-slate-400 hover:text-white transition font-medium">Equipe</button></li>
                </ul>
              </div>
              <div>
                <h5 className="font-black text-white mb-8 text-[10px] uppercase tracking-[0.3em] opacity-40">Contato</h5>
          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-8 text-slate-500 text-[10px] font-black uppercase tracking-[0.2em]">
            <p>&copy; 2024 {settings.salonName}. Todos os direitos reservados.</p>
